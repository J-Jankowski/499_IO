...
#define	MYTIM4_PERIOD ((uint16_t)0x0690)				// debouncing timer runs for 10ms
#define myTIM4_PRESCALER ((uint32_t)0x3138)				// so need to count to 1680000/1000=1680=0x0690
